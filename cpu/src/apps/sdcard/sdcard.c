...
int32_t cpu_ipc_receive_buffer [MIN_IPC_TRANSFER_SIZE] ;
...
if (cpu_ipc_receive_buffer[0]==1){ 
    cpu_callback_function(); // buscar en una tabla por indice pero por ahoar asi
