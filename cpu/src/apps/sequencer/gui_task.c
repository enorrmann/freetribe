...
void gui_post_event_at_line(const Sequencer *seq, const SeqEvent *evt, int line) {
    ...
    //char *flat = "b";
    char *space = " ";
    int octave = evt->midi_params.data1 / 12;
    int gate = evt->peer_event->timestamp_tick - evt->timestamp_tick  ;
    int vel = evt->midi_params.data2;
    //int is_flat = 1;
    ...
    strncpy(&cat_string[5], note_names[note], 2);
    ...
    gui_print(0, line * spacing, cat_string);
}
